  ...
  return (
    <section id="leadership" className="py-20 bg-[#faf7ef] border-b border-[#cfc6a6]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-20 pb-16 border-b border-[#cfc6a6]">
          <div className="mb-8">
            <span className="eyebrow text-[#b6842a]">PRESIDENTIAL TICKET &bull; 2027</span>
            <h3 className="font-display text-2xl sm:text-3xl font-semibold text-[#10241f] mt-1">
              Our Presidential Principals
            </h3>
            <p className="text-xs sm:text-sm text-[#666c5c] mt-1.5 max-w-xl">
              ...
              >
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div>
                    ...
                    <h4 className="font-display text-xl sm:text-2xl font-bold text-[#10241f] leading-snug">
                      {principal.name}
                    </h4>
